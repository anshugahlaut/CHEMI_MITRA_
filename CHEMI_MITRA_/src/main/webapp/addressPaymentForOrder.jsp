...
<div class="right-div">
<h3>Pay online on this @CHEMI MITRA.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="number"  name="mobileNumber" value="<%=rs2.getString(3) %>" placeholder="Enter Mobile Numbers" required">
