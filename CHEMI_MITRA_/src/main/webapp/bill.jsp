...
try{
	...
	ResultSet rs2=st.executeQuery("select * from users inner join cart where users.email='"+email+"' and cart.email='"+email+"'");
	while(rs2.next()){
		String nm =rs2.getString(1);
		
%>
<h3>Medicine Purchasing Bills : <%=email %></h3>
<hr>
...
<a href="continueShopping.jsp"><button class="button left-button">Continue Purchasing</button></a>
