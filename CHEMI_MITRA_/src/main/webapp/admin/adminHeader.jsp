...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String email=session.getAttribute("email").toString();%>
              <center><h2 style="font-family: Colonna MT"><b style="letter-spacing: 5px;text-shadow:3px 3px 6px">CHEMI MITRA</b></h2></center>
            <a href="addNewProduct.jsp">Add New Medicine <i class='fas fa-plus-square'></i></a>
            <a href="allProductEditProduct.jsp">All Medicine & Edit Medicine <i class='fab fa-elementor'></i></a>
