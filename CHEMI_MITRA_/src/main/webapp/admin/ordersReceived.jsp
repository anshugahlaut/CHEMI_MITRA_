...
<table id="customers">
     ...
     String nm="";
        ...
        try{
        	...
        	ResultSet rs=st.executeQuery("select * from cart inner join product where cart.product_id=product.id and cart.orderDate is not Null and cart.status in ('processing','bill')");
        	while(rs.next()){
